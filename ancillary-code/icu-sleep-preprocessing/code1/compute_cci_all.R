...
# file_list = list.files("C:/Users/wg984/Dropbox (Partners HealthCare)/ICU-SLEEP-MATERIALS/Data/Diagnosis_ICDs/", pattern=NULL, all.files=FALSE, full.names=FALSE)
# output_folder = "C:/Users/wg984/Dropbox (Partners HealthCare)/ICU-SLEEP-MATERIALS/Data/Diagnosis_ICDs/"
# input_folder = "C:/Users/wg984/Dropbox (Partners HealthCare)/ICU-SLEEP-MATERIALS/Data/Diagnosis_ICDs/"'

file_list = list.files("C:/Users/wg984/Wolfgang/tmp/", pattern=NULL, all.files=FALSE, full.names=FALSE)
output_folder = "C:/Users/wg984/Wolfgang/tmp/"
input_folder = "C:/Users/wg984/Wolfgang/tmp/"
...
for (file in file_list){
  ...
  if (grepl(".csv", file, fixed = TRUE)[1] == TRUE ){
    ...
    if (file.exists(output_name)){
      ...
      charlson <- comorbidity(x = data, id = "PatientIdentityID", code = "CurrentICD10ListTXT", score = "charlson", icd = "icd10", assign0 = FALSE)
