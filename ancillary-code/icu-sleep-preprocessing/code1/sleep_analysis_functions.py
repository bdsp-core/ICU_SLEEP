...
sys.path.append('/home/wolfgang/repos/central_apnea_app')
...
#         gc.collect()
#
#     print(spo2_collection_100s_prior.shape)
#     print(spo2_collection_100s_prior)
