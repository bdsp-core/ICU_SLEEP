...
def remove_outliers(t,trace,fs, min_height=0.01):
...
def generate_report(trace, centr_detected_final, centr_hypo_final, fs):
...
def plot_central_events(trace, centr_detected_final, centr_hypo_final):
    ...
    # save the figure
    plt.savefig('figure_central_resp_events.pdf')
    plt.savefig('figure_central_resp_events.png')
...
def main():
    ...
    # data_path = 'trace.mat'
    datadir = '';
    # datadir = 'M:/Projects/SLEEP/SLEEP_STAGING/MGH_Data/ThousandsOfNewCases/ExtractedSignalAndLabels/';
    data_path = os.path.join(datadir,'Signal_TwinData4_952.mat')
    # sampling frequency
    fs = 200

    #central_respiration_event_detection(data_path,fs)
